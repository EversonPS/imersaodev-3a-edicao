...
form.addEventListener("submit", adicionaTimeNovoNaTabela);
...
function adicionaNaTabela(time) {
  ...
  botaoAdicionaVitoria.addEventListener("click", function () {
    adicionaVitoria(time);
  });
  ...
  botaoAdicionaEmpate.addEventListener("click", function () {
    adicionaEmpate(time);
  });
  ...
  botaoAdicionaDerrota.addEventListener("click", function () {
    adicionaDerrota(time);
  });
...
function adicionaTimeNovoNaTabela(event) {
  event.preventDefault();
  var time = {
    nome: form.time.value,
    vitorias: parseInt(form.vitorias.value),
    empates: parseInt(form.empates.value),
    derrotas: parseInt(form.derrotas.value),
    pontos: 0
  };
